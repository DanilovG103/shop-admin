...
INSERT INTO "new_Request" ("address", "createdAt", "id", "paymentType", "recipientLastName", "recipientName", "rejectReason", "status", "sum", "user") SELECT "address", "createdAt", "id", "paymentType", "recipientLastName", "recipientName", "rejectReason", "status", "sum", "user" FROM "Request";
DROP TABLE "Request";
